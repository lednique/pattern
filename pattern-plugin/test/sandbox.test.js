...
(async function(){
  ...
  const halfFrame=page.selection[0];assert(Math.abs(halfFrame.children[0].width-(256/3))<1e-6);assert.equal(halfFrame.children.length,30);
  ...
  console.log('  ✓ half-grid midpoint repeats keep the regular figure size');
