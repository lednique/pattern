...
test('half grid keeps midpoint figures at the regular figure size',()=>{const normal=core.normalizeSettings({...base,columns:3,rows:3,halfGrid:false}),half=core.normalizeSettings({...base,columns:3,rows:3,halfGrid:true});assert.deepEqual(core.fitDimensions(100,100,half,100),core.fitDimensions(100,100,normal,100));});
